...
let scoreVergelijking = () => {
    ...
    if (monsterType.Wapen === "Korte Afstand" && avonturier.Pantser === "Zwaar") {                                                                  //Als het wapen van het monster een Schild is, en het Pantser van de avonturier zwaar:
    ...
    } else if (monsterType.Wapen === "Magie" && avonturier.Pantser === "Zwaar") {                                                             //Als het wapen van het monster een Spreuk is, en het Pantser van de avonturier zwaar:
        ...
        document.getElementById("GameTekst").innerHTML = 
        `Er is geen pantser keuze bekend.`;
    };
...
const conflict = () => {
    ...
    if (aanval === avonturier.Scores.Korte_Afstand) {                                                           //Als de variabel aanval (hierboven gedefinieerd) gelijk staat aan een Korte Afstand Score van de avonturier, voer dan de volgende if-statement uit.
